...
class TooltipHelper(private val context: Context) {
    ...
    fun showTooltip(
        ...
        tooltipParams.setMargins(0, arrowMarginTop, 0, arrowMarginBottom)
        ...
        arrowParams.gravity =
            if (isBottomRegionBoolean) Gravity.CENTER_HORIZONTAL or Gravity.BOTTOM else Gravity.CENTER_HORIZONTAL
